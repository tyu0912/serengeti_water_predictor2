...
navbarPage(title=img(src = "images/logo/Original-transparent_novertborder.png", height=40, alt="Re:source"), tags$style(HTML('.navbar-nav > li > a {line-height:38px}, .navbar-brand {
           ...
           tabPanel(strong("Interactive map"),
                    ...
                    div(class = "outer",
                        ...
                        absolutePanel(id = "controls", class = "panel panel-default",
                                      ...
                                      div(id = "inputs",
                                          actionButton("hide_controls", "Hide Controls", icon = icon("minus-square"),
                                      ...
                                      shinyjs::hidden(
                                        actionButton("show_controls", "Show Controls", icon = icon("plus-square"),
                                                     style="color: #fff; background-color: #4db6acff; border-color: #4db6acff")
                                      ),
                                      # br(),
                                      # div(id = "inputs2",
                      ...
                      fluidRow(
                        ...
                        fluidRow(
                          ...
                          column(width = 6, align = "center",
                                 ...
                                 h1('Jason Baker'),
                                 h4("Analytic Methodologist @ US DoD"),
                                 h4("St. Louis, MO"),
